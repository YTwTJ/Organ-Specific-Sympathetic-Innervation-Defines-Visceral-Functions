# CGSMG scRNA-seq dotplots for ExFig4a
...
clusters_of_interest = ['77', '96']
adata_filtered = adata[adata.obs['leiden'].isin(clusters_of_interest)]
adata_filtered.obs['leiden_renamed'] = adata_filtered.obs['leiden'].replace({'77': 'BMP3+', '96': 'DSP+'})

markersCluster = ['Shox2','Cntn5','Astn2','Atxn7l3b','Arl6ip1','Rpl32','Ppia','Itm2b','Ptma','mt-Atp6','mt-Co2','Gm29266','Bmpr1b','Csmd3','Slc35f4','Pdzrn3','Gpr176','Opcml','Kirrel3','Casz1','Sdk1']
sc.pl.dotplot(adata_filtered, markersCluster, groupby='leiden_renamed', dendrogram=False)
